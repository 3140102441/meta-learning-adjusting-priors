...
from Utils.Caltech256 import load_pretrain_dataset
...
train_loader = DataLoader(train_dataset, batch_size=bz, shuffle=True, num_workers =4, pin_memory = True)
print(len(train_dataset), len(test_dataset))
test_loader = DataLoader(test_dataset, batch_size=bz, shuffle=True, num_workers =4, pin_memory = True)
save_dir = "pretrained_caltech256_1"
os.makedirs(save_dir,  exist_ok=True)

net = get_model(prm)

#load_model_state(net, save_dir + "/" + "epoch-7-acc0.303.pth")
