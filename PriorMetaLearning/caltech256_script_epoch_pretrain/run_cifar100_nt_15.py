...
call(['python', 'main_Meta_Bayes.py',
      ...
      '--run-name', 'Caltech256__comp_{}_ntr_{}_nte_{}_task-w_{}_meta-w_{}_pre-{}'.format( complexity_type, n_train_tasks, n_test_tasks, task_complex_w, meta_complex_w, str(pretrain)),
      '--data-source', 'Caltech256',
      '--data-transform', 'None',
      '--batch-size', '16',
